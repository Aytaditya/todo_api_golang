...
func (s *Sqlite) CreateUser(username *string, email *string, password *string) (int64, string, error) {
...
func (s *Sqlite) Login(email *string, password *string) (int64, string, error) {
